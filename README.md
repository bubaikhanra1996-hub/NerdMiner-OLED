...
Enjoy
\n\n## ESP32 DevKit V1 + SSD1306 128x64 OLED\n\nThe `ESP32-devKitv1` environment is configured for an I2C SSD1306 128x64 OLED:\n- SDA: GPIO 21\n- SCL: GPIO 22\n- VCC: 3.3V\n- GND: GND\n\nBuild with PlatformIO using the `ESP32-devKitv1` environment.\n